									...
									<p class="text-muted font-13">신청 후에 수정과 삭제는 불가합니다.</p>
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="inputEmail4" class="col-form-label">학번</label>
												 <input type="text" name="userNo" id="userNo" value="${applyVO.userNo}" class="form-control" disabled="disabled">
											</div>
											<div class="form-group col-md-6">
												<label for="inputPassword4" class="col-form-label">이름</label>
												<input type="text" name="userName" id="userName" value="${applyVO.userName}" class="form-control" disabled="disabled">
											</div>
										</div>
										...
										<div class="form-group" style="display: none;">
											<label for="inputAddress2" class="col-form-label">사유 :: 직접입력</label>	
											<input type="text" id="directReason" name="reason" class="form-control" disabled="disabled">
										</div>
										</c:if>
										
										<c:if test="${applyVO.applyState eq '승인' or  applyVO.applyState eq '거절'}">
										<div class="form-group" id="reason">
											<label for="inputAddress2" class="col-form-label">사유</label> 
...
$("#selectReason").change(function(){
	$("#selectReason option:selected").each(function(){
		if($(this).val() == "1"){
			$("#selectReason").attr("name", "disabled");
			$("#directReason").attr("disabled", false);
			$("#directReason").parent().attr("style", "display:inline;");
		} else{
			$("#selectReason").attr("name", "reason");
			$("#directReason").attr("disabled", true);
			$("#directReason").parent().attr("style", "display:none;");
		}
	});
});
